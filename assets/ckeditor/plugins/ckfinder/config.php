...
//$baseUrl = realpath(dirname(__FILE__) . '/../../media');
//$baseUrl = dirname(__FILE__); //the directory holding this plugin
...
$dir_htmledit = substr ($_SERVER ['PHP_SELF'], 0, strpos ($_SERVER ['PHP_SELF'], "assets/ckeditor/plugins/ckfinder"));
$baseUrl = $dir_htmledit. "media/ckeditor/";
