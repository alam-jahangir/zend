...
class GeneratePassword {
    ...
    public static function processPassword($password = '', $type = 'user')
    {
		if ($type != 'user') {
            return  $password != '' ? ($password.self::$_adminSecuritySalt): '';
        }
        return  $password != '' ? ($password.self::$_userSecuritySalt): '';
	}
}